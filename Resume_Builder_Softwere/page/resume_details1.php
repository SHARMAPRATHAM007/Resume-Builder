...
<form method="POST" action="<?=$action->helper->url('action/createresume')?>" class="border border-2 rounded-2 p-2 my-4" >
...
<div class="row justify-content-between mt-3">
  ...
  <div class="col-6 mb-3">
    ...
    <div class="">
      <!-- <input type="number" class="form-control" id="inputEmail3" name="mobile" placeholder="9348987865" required> -->
      <input type="taxt"  class="form-control" id="inputEmail3" name="mobile"  maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" placeholder="81418098xx" required>
    </div>
  </div>
  </div>
  ...
  <button type="submit" class="btn btn-warning"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="17" fill="currentColor" class="bi bi-box2 " viewBox="0 0 16 16">
