 <!-- <?php/* print_r($resumes); */?>-->
<div class="container">
    <a href="<?=$action->helper->url('select-template')?>" class="btn btn-secondary my-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-plus-square-fill pb-1" viewBox="0 0 16 16">
...
<div class="card my-3">
    <div class="card-body">
        ...
        <a href="<?=$action->helper->url("resume/".$resume['url'])?>" class="btn btn-sm btn-success">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-binoculars pb-1" viewBox="0 0 16 16">
        ...
        View</a>
         ...
         <!-- <a href="<=$action->helper->url("action/download/".$resume['url'])?>" class="btn btn-sm btn-primary"  id="btn-convert" >
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-pencil-square pb-1" viewBox="0 0 16 16">
        ...
        <a href="<?=$action->helper->url("action/deleteresume/".$resume['url'])?>" class="btn btn-sm btn-danger">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-trash3 pb-1" viewBox="0 0 16 16">
        ...
        <!-- <a href="#" class="btn btn-sm btn-warning">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-link-45deg pb-0" viewBox="0 0 16 16">
            <path d="M4.715 6.542 3.343 7.914a3 3 0 1 0 4.243 4.243l1.828-1.829A3 3 0 0 0 8.586 5.5L8 6.086a1.002 1.002 0 0 0-.154.199 2 2 0 0 1 .861 3.337L6.88 11.45a2 2 0 1 1-2.83-2.83l.793-.792a4.018 4.018 0 0 1-.128-1.287z"/>
            <path d="M6.586 4.672A3 3 0 0 0 7.414 9.5l.775-.776a2 2 0 0 1-.896-3.346L9.12 3.55a2 2 0 1 1 2.83 2.83l-.793.792c.112.42.155.855.128 1.287l1.372-1.372a3 3 0 1 0-4.243-4.243L6.586 4.672z"/>
            </svg>
        Create Url</a> -->

        <a href="#" class="btn btn-sm btn-warning" onclick="copyurl('<?=$action->helper->url("resume/".$resume['url'])?>')">
            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-clipboard pb-1" viewBox="0 0 16 16">
...
<div class="card my-3">
    <div class="card-body">
        <h2 class="text-center text-muted">
            <svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" fill="currentColor" class="bi bi-cloud-rain" viewBox="0 0 16 16">
...
<!-- Microsoft and Google certified Solution Developer and AWS certified Solutions Architect. Built infrastructure to hendle milions of client files in proprietary system. -->
</div>
